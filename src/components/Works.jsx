    ...
    return (
        <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
            <Tilt
                ...
                className='bg-white dark:bg-tertiary p-5 rounded-2xl sm:w-[360px] w-full h-full border border-gray-200 dark:border-white/10 shadow-lg dark:shadow-none'
            >
                ...
                <div className='mt-5 h-[150px] flex flex-col justify-between'>
                    <div>
                        <h3 className='text-black dark:text-white font-bold text-[24px]'>{name}</h3>
                        <p className='mt-2 text-gray-600 dark:text-secondary text-[14px] line-clamp-3'>{description}</p>
                    </div>
